	...
	<div class="services">
		<div class="container">
			<div class="w3layouts_header">
				<h2>Password<span>Changed</span>  </h2>
				...
				<form action="utils/register.php" method="post">
					...
					<div class="grid_3 grid_5 w3ls">
						...
						<div class="alert alert-success text-center" role="alert">
							<strong>Congratulations! !</strong> Your Password successfullly updated  !  You will need to logout.
							<p>
							<a href='index.php' class='btn btn-info'> <i class='fa fa-home'></i> Home</a>
                            <a href='../utils/logout.php' class='btn btn-danger'> <i class='fa fa-home'></i> logout</a>
							</p>
						</div>
					</div>
