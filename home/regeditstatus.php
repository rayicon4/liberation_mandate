...
<html lang="en">
<head>
<title>Liberation Mandate | Regitration Edit</title>
<!-- custom-theme -->
				...
				<form action="utils/register.php" method="post">
					...
					<div class="grid_3 grid_5 w3ls">
                        ...
                        <div class="alert alert-danger text-center" role="alert">
                            ...
                            <strong>Failed !</strong> The phone number is already in use.
                             <p></p>  
                            <br>
                            <p>
                        ...
                        <div class="alert alert-success text-center" role="alert">
							<strong>Congratulations! !</strong> All corrections have been made. Thank you
							<p>
							<a href='index.php' class='btn btn-info'> <i class='fa fa-home'></i> Home</a>
