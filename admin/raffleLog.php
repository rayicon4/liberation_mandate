...
{ 
  ...
  $data = $op->selectLogs($center->id, $id); 
}
          ...
          <div class="row" style='font-size: 14px'>
            <div class="col-lg-12">
              ...
              <div class="float-right"> 
                    <a  class='btn btn-success' href='raffleHistory.php?id=<?php echo $center->id;?>'> Raffle History </a>
                        ...
                        <td class='a_row text-left' data-id='<?php echo $p->id;?>'>  
                          <b class='nlot' id='namez<?php echo $p->id;?>'>
                            <?php
                              ...
                              echo '<i data-id="'.$id.'" data-mid="'.$d->id.'" class="fa fa-star text-success cforce"></i>';
...
<!-- Add Center -->
  ...
  $(document).on('click', '.cforce', function(){ 
      var id = $(this).attr('data-id'); 
      var mid = $(this).attr('data-mid'); 
      var r = confirm('Are you sure you want this client to win. he /She will be replacing a selected winner', 'Yes', 'No');

      if(r == true)
      {
        
        $.post('utils/changeWin.php', {id:id, mid:mid},  function(dat, status){
            if(status == 'success')
            {
                alert(dat);
            }
