...
if(isset($_GET['sls']))
{
  ...
  if($_GET['sls'] == 'all')
  {
    $data = $op->selectClients(NULL, NULL, $ac);
  }
  else
  {
    $sls = explode(',', $_GET['sls'] );
    if($sls[1] == 'xx')
    {
      $data = $op->selectClients($sls[0], null, $ac);
    }
    else
    {
      $data = $op->selectClients(null, $sls[1], $ac);
    }
  }
}
                  ...
                  <input type='hidden' name='center' value='<?php echo $id;?>'>
                    ...
                    foreach($data as $d)
                    {
                      ...
                      <tr id='roz<?php echo $d->id;?>'>          
                        ...
                        <a class="dropdown-item" href="raffleAdd.php?id=<?php echo $d->id;?>"> Place Raffle</a>
                        <a class="dropdown-item" href="raffleHistory.php?id=<?php echo $d->id;?>"> Raffle History</a>
                        <a class="dropdown-item" href="mandatesAdd.php?id=<?php echo $d->id;?>&edit=<?php echo $d->id;?>">Edit</a>
                        <a class="dropdown-item" target='_blank' href="../profile/profile.php?id=<?php echo $d->id;?>">Profile</a> 
