...
{ 
  ...
  $data = $op->selectLogsSummary($center->id, $id, 1, NULL); 
}
        ...
        <div class="container-fluid">
          ...
          <div class="row" style='font-size: 14px'>
            <div class="col-lg-12">
              ...
              <h1>
                 <i class='fa fa-instituition'></i>  Liberators Mandate <small><?php echo $title_name.'   ('.$id.')';?> Raffle Log</small>
              </h1>
              
              </span>
              <span class='col-md-6 '>
              <div class="float-right btn-group"> 
                  <button  class='btn btn-success' data-id ="<?php echo $id;?>" data-mid="<?php echo $mid;?>" id='mclear' > View All </nutton>
                        ...
                        <td class='a_row text-left' data-id='<?php echo $p->id;?>'>  
                          <b class='nlot' id='namez<?php echo $p->id;?>'>
                            <?php
                              ...
                              echo '<a href="raffleWinCenters.php?id='.$id.'&mid='.$d->gift.'&pid='.$d->center.'">';
                              echo ucwords(strtolower($d->centername));
                              echo '</a>';
