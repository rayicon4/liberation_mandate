...
if(isset($_POST['submit']))
{
  ...
  foreach($_POST['sid'] as $a => $ar)
  {
    $tid = $op->selectOne($db, NULL, array('id'=>$a));
    //if(strlen($tid->abbrv) > 0)
    //{
      $op->update($db, array('abbrv' => strtoupper($ar)), array('id' =>$a));
    //}

  }

  //header('location:lga.php?sls='.$id);
...
{
  $id =  $_GET['sls'];
  $data = $op->select('local_governments', NULL, array('state_id' => $_GET['sls']));
}
else
{
  $data = array();
          ...
          <div class="row" style='font-size: 14px'>
            <div class="col-lg-12">
              ...
              <form class='form' action='' method='get'>
                ...
                <div class="card-body">
                 <form action='lga.php?sls=<?php echo $id;?>' method='post' >
                    ...
                    foreach($data as $d)
                    {
                      ...
                      <tr id='roz<?php echo $d->id;?>'>          
                        ...
                        <td class='a_row' >  
                          ...
                          <input type='text' name='sid[<?php echo $d->id;?>]' value='<?php echo $d->abbrv;?>'>
